...
$result = mysqli_query($link, "SELECT * FROM indumentaria"); 
                ...
                <div class="card h-100">
                    <div class="card-body">
                        <img class="card-img-top"
                            src="https://nikearprod.vtexassets.com/arquivos/ids/533215-800-800?v=638161405778670000&width=800&height=800&aspect=true"
                            alt="Remera Nike">
                    </div>
...
mysqli_free_result($result); ?>
            ...
            <div class="col-md-3 p-1">
                <div class="card h-100">
                    <div class="card-body">
                        <img class="card-img-top"
                            src="https://media.solodeportes.com.ar/media/catalog/product/cache/7c4f9b393f0b8cb75f2b74fe5e9e52aa/p/a/pantalon-adidas-deportivo-sst-ni_o-ni_a-negro-10002ege1997001-1.jpg"
                            alt="Pantalon Adidas">
                    </div>
...
mysqli_free_result($result); ?>
            ...
            <div class="col-md-3 p-1">
                <div class="card h-100">
                    <div class="card-body">
                        <img class="card-img-top"
                            src="https://www.cristobalcolon.com/fullaccess/item30343foto125219th.jpg"
                            alt="Shorts shorty Rip curl">
                    </div>
...
mysqli_free_result($result); ?>
            ...
            <div class="col-md-3 p-1">
                <div class="card h-100">
                    <div class="card-body">
                        <img class="card-img-top"
                            src="https://www.digitalsport.com.ar/files/products/6112a7ca63293-564270-1200x1200.jpg"
                            alt="Buzo swoosh nike">
                    </div>
